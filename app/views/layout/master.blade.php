...
<html lang="en">
	...
	@yield("stylesheet")
		<script type="text/javascript">
			...
			// Data
			Site.data = Site.data || {};
			Site.data.page = '{{ json_encode($page) }}';
		</script>
		<!-- Boot Data -->
		@yield("bootdata")
	</head>
	<body>
		<!-- Begin Facebook SDK -->
			...
			<script>(function(d, s, id) {
			  ...
			  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.4&appId=1574913019449119";
		...
		{{ HTML::script('assets/site/plugins/geolocator/geolocator.min.js') }}
		{{ HTML::script('assets/site/plugins/jquery-cookie/jquery.cookie.js') }}
		{{ HTML::script('assets/site/plugins/math-uuid/Math.uuid.js') }}
		{{ HTML::script('assets/site/plugins/ua-parser-js/ua-parser.min.js') }}
		{{ HTML::script('assets/site/plugins/purl/purl.js') }}
		{{ HTML::script('assets/site/plugins/keen-js/keen.min.js') }}
		<!-- Frontend Javascript -->
		@if(App::environment() == 'local')
