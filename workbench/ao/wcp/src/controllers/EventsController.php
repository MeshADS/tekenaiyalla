...
class EventsController extends WcpController{
	...
	*/
	public function index()
	{
		...
		// Load view
		return View::make('wcp::pages.events.list', $this->viewdata);
	}
	...
	*/
	public function update($id)
	{
		...
		if (count($item) < 1) {
			// Flash message
			Session::flash("system_message", ["level"=>"danger",  "access"=>"wcp", "type"=>"page", "message"=>"Events does not exist."]);
			// Redirect back
