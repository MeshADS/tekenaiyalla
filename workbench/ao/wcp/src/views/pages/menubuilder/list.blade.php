...
@section('jumbotron_breadcrumb')
	<ul class="breadcrumb">
	    ...
	    <li><a href="{{ Request::url() }}" class="active">Menu Builder</a>
	    </li>
	</ul>
@stop
@section('jumbotron')
							...
							<div class="modal-content">
								{{ Form::open(["url"=>"admin/menubuilder", "role"=>"form"]) }}
									...
									<div class="modal-body">
										...
										<div class="form-group form-group-default m-t-10">
											{{ Form::label("url", "URL") }}
											{{ Form::textarea("url", "", ["class"=>"form-control", "placeholder"=>"E.g. ".URL::to('')]) }}
										</div>
										...
										<div class="form-group form-group-default m-t-10">
											...
											{{ Form::select("color", $coloroptions, "", ["class"=>"form-control"]) }}
										</div>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<div class="form-group form-group-default m-t-10">
											...
											<textarea class="form-control" placeholder="E.g. {{ URL::to('') }}" name="url" cols="50" rows="10" id="url">{{ $item->url }}</textarea>
										</div>
					            ...
					            <td>
					            	<div class="btn-group dropdown-default">
									    ...
									    <ul class="dropdown-menu ">
									        ...
									        <li><a href="{{ URL::to('admin/menubuilder/'.$item->id.'/submenus') }}">Submenus</a>
									        </li>
									    </ul>
									</div>
					            </td>
