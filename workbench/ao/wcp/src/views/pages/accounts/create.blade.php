			...
			<div class="col-md-12">
				...
				<div class="panel">
					<ul class="nav nav-tabs nav-tabs-simple">
					    ...
					    <li>
					      <a data-toggle="tab" href="#biotab">Bio</a>
					    </li>
					</ul>
					<div class="tab-content">
					        ...
					        <div class="col-md-6">
					         ...
					         <div class="form-group form-group-default">
					         	{{ Form::label("username", "Username") }}
					          	{{ Form::text("username", "", ["class"=>"form-control", "placeholder"=>"johndoe"]) }}
					    ...
					    {{-- End Basic Info Tab --}}
					    {{-- Begin Bio Tab --}}
					    <div class="tab-pane active" id="biotab">
					      <div class="row column-seperation">
					      	{{-- Begin Column --}}
					        <div class="col-md-6">
					          	...
					          	<div class="form-group form-group-default">
									{{ Form::label("bio", "Bio") }}
									{{ Form::textarea("bio", "", ["class"=>"form-control", "placeholder"=>"Enter bio here"]) }}
								</div>

								<div class="form-group form-group-default">
									{{ Form::label("facebook", "Facebook") }}
									{{ Form::text("facebook", "", ["class"=>"form-control", "placeholder"=>"Enter handle here. E.g. username"]) }}
								</div>

								<div class="form-group form-group-default">
									{{ Form::label("twitter", "Twitter") }}
									{{ Form::text("twitter", "", ["class"=>"form-control", "placeholder"=>"Enter handle here. E.g. username"]) }}
								</div>

								<div class="form-group form-group-default">
									{{ Form::label("instagram", "Instagram") }}
									{{ Form::text("instagram", "", ["class"=>"form-control", "placeholder"=>"Enter handle here. E.g. username"]) }}
								</div>
