				...
				<div class="panel-body">
					{{ Form::open(["url"=>"admin/posts", "method"=>"get"]) }}
						<div class="input-group">
							{{ Form::text("search", $search, ["class"=>"form-control", "placeholder"=>"Search here...", "autocomplete"=>"off"]) }}
						...
						@foreach($row as $item)
							...
							<div class="col-md-4">
								...
								<div class="panel panel-default">
									...
									{{-- Begin Panel Body --}}
									<div class="panel-body">
										<a href="{{ URL::to('admin/posts/'.$item->id) }}" class="portlet-maximize" data-toggle="" title="Read">
											<h5>{{ $item->title }}</h5>
