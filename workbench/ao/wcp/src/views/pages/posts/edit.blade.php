...
@section("bootdata")
	 <script type="text/javascript">
        //Data
        Site.data = Site.data || {};
        Site.data.authors = '{{ json_encode($authors) }}';
    </script>
@stop
@section('content')
				...
				<div class="container-fluid">
					...
					<div class="col-md-4">
						...
						<div class="form-group form-group-default">
							...
							<small class="m-t-10">
								Select a new image to change current image.<br>
								<strong>Width:1280px - Height:1024</strong>
							</small>
						</div>
						...
						<div class="form-group">
					        ...
					        <input type="hidden" id="author_id" name="author_id" value="{{ $item->author->id }}" class="full-width">
					    </div>
...
@section("javascript")
	...
	<script type="text/javascript">
		$(function(){
			...
			var authors = $.parseJSON(Site.data.authors);
			var authorsArr = [];
