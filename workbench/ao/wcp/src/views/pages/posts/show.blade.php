				...
				<div class="container-fluid">
					...
					<div class="col-md-8">
						<a href="{{ URL::to($item->image) }}" class="fancyboxGroup">
							<img src="{{ URL::to($item->thumbnail) }}" style="width:100%;" class="m-b-30">
						</a>
					...
					<div class="col-md-4">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<img src="{{ URL::to($item->author->avatar) }}" 
									alt="{{ $item->author->first_name.' '.$item->author->last_name }}" 
									width="36px" 
									style="position:relative: float:left; padding-right:5px; padding-right:5px; padding-bottom:5px;">
