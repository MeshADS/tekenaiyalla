          ...
          {{ Form::open(["url"=>"admin/accounts/".$user_data->id, "role"=>"form", "method"=>"put"]) }}
            ...
            <div class="modal-body">
              ...
              <div class="form-group form-group-default">
                ...
                <input type="text" name="username" id="username" class="form-control" placeholder="Enter last name" value="{{ $user_data->username }}">
                <small class="bold">Only the following characters sets are accepted A-z, 0-9, underscores and dashes</small>
              </div>

              <div class="form-group">
                {{ Form::label("bio", "Bio") }}
                <textarea name="bio" id="bio" class="form-control" rows="3" placeholder="Enter your bio here..">{{ $user_data->bio }}</textarea>
              </div>

              <div class="form-group form-group-default">
                {{ Form::label("facebook", "Facebook") }}
                <input type="text" name="facebook" id="facebook" class="form-control" placeholder="Enter handle here. E.g. username" value="{{ $user_data->facebook }}">
              </div>

              <div class="form-group form-group-default">
                {{ Form::label("twitter", "Twitter") }}
                <input type="text" name="twitter" id="twitter" class="form-control" placeholder="Enter handle here. E.g. username" value="{{ $user_data->twitter }}">
              </div>

              <div class="form-group form-group-default">
                {{ Form::label("instagram", "Instagram") }}
                <input type="text" name="instagram" id="instagram" class="form-control" placeholder="Enter handle here. E.g. username" value="{{ $user_data->instagram }}">
              </div>
