    ...
    $(document).ready(function() {
            ...
            for (var i = loadEvents.length - 1; i >= 0; i--) {
                ...
                evArr[i] = {
                            ...
                            other:{
                                ...
                                description: loadEvents[i].description,
                                venue: loadEvents[i].venue,
                                id: loadEvents[i].id,
                            }
                          };
            };
        ...
        var functions = {
            ...
            setEventDetailsToForm: function(event) {
                ...
                $('#editForm #description').val(event.other.description);
                $('#editForm #venue').val(event.other.venue);
            ...
            setEventDetailsToCreatForm: function(event) {
                ...
                $('#createForm #description').val(event.other.description);
                $('#createForm #venue').val(event.other.venue);
            },
            ...
            setEventDetailsToUpdate: function(event) {
                ...
                var eventUpdateData = {
                    ...
                    description:event.other.description,
                    venue:event.other.venue,
                    id:event.other.id,
                    url: url+"admin/events/"+event.other.id
                };
        ...
        $('#editForm').submit(function(event) {
            ...
            var newData = {
                ...
                venue: $('#editForm #venue').val(),
                id: $('#editForm #id').val(),
                code:$('#editForm #code').val(),
                url: url+"admin/events/"+$('#editForm #id').val()
            };
            // Disable form
        ...
        $('#deleteForm').submit(function(event) {
            ...
            var newData = {
                ...
                url: url+"admin/events/"+$('#deleteForm #id').val()+"/delete"
            };
            // Disable form
